...
release-candidate-check: check check-browser-tests-lint test-all ui check-sdk-build check-installer check-sync-pipeline test-demo-launch test-demo-e2e test-smoke ## Run the trusted public release candidate gate
