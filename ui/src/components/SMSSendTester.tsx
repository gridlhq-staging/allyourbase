    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-40">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={onClose} className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 dark:text-gray-300">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="space-y-4">
          <div>
            <label htmlFor="sms-phone" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
              To (phone number)
            </label>
            <input
              id="sms-phone"
          ...
          <div>
            <label htmlFor="sms-body" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
              Message body
            </label>
            <textarea
              id="sms-body"
