...
require_file_match "$dart_manifest" "^repository: https://github\\.com/AllyourbaseHQ/allyourbase$" "sdk_dart/pubspec.yaml missing canonical public repository URL"
require_file_match "$dart_manifest" "^issue_tracker: https://github\\.com/AllyourbaseHQ/allyourbase/issues$" "sdk_dart/pubspec.yaml missing canonical public issue tracker URL"
...
require_file_match "$go_guide" "^git clone https://github\\.com/AllyourbaseHQ/allyourbase\\.git$" "go-sdk.md missing public source checkout command"
...
reject_files_match "go get github\\.com/AllyourbaseHQ/allyourbase/sdk_go@latest" "go-sdk.md still presents the failing public Go SDK path as installable" "$go_guide"
...
require_file_match "$react_guide" "^git clone https://github\\.com/AllyourbaseHQ/allyourbase\\.git$" "react-sdk.md missing public source checkout command"
...
require_file_match "$ssr_guide" "^git clone https://github\\.com/AllyourbaseHQ/allyourbase\\.git$" "ssr-sdk.md missing public source checkout command"
...
reject_files_match "brew install (gridlhq|griddlehq|AllyourbaseHQ)/tap/ayb" "public docs still advertise a nonexistent Homebrew tap" "$readme_doc" "$index_guide" "$getting_started_guide"
