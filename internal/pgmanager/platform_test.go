...
func TestDownloadURLDefault(t *testing.T) {
	...
	want := "https://github.com/AllyourbaseHQ/allyourbase/releases/download/pg-16/ayb-postgres-16-darwin-arm64.tar.xz"
...
func TestDownloadURLDefaultLinux(t *testing.T) {
	...
	want := "https://github.com/AllyourbaseHQ/allyourbase/releases/download/pg-17/ayb-postgres-17-linux-amd64.tar.xz"
	testutil.Equal(t, want, got)
}
...
func TestSHA256SumsURLDefault(t *testing.T) {
	...
	want := "https://github.com/AllyourbaseHQ/allyourbase/releases/download/pg-16/SHA256SUMS"
	testutil.Equal(t, want, got)
}
