...
//go:embed instantsearch_demo/schema.sql instantsearch_demo/seed.sql kanban/schema.sql live-polls/schema.sql movies/schema.sql movies/seed.sql movies/embeddings.json movies/ayb.toml
var FS embed.FS
